...
template<>
NewObjectDialog<Conversation> * NewObjectDialog<Conversation>::Create(QWidget *parent, Qt::WindowFlags flags)
{
    return new NewConversationDialog(parent, flags);
}

NewConversationDialog::NewConversationDialog(QWidget *parent, Qt::WindowFlags flags) :
    NewObjectDialog<Conversation>(parent, flags)
{
    ...
    pIdPromptLabel = new QLabel("Conversation ID: ");
    ...
    setWindowTitle("Conversation creation");
}

Conversation * NewConversationDialog::GetNewObject()
{
    return new Conversation(id);
}

void NewConversationDialog::InitFields()
{
    id = "";
...
bool NewConversationDialog::ValidateFields()
{
...
bool NewConversationDialog::ValidateId()
{
    ...
    else
    {
        ...
        pIdErrorLabel->setText("Error: Conversation ID cannot be blank.");
        return false;
    }
}
